    ...
    <div class="col-md-9">
        <div class="tab-content">
            ...
            <div style="margin: 2% 5% 0 5%">
                <form action="commodity_add.php" method="post">
                        <input class='btn btn-primary btn-lg' type="submit" value="新增">
                </form>
            </div>
            <div style="margin: 2% 5% 0 5%">
                <div class="tab-content-center">
                    ...
                    <?php
                        ...
                        if($result=mysqli_query($link,$SQL)){
                            echo "<table class='table table-striped table-sm'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th>商品編號</th><th>商品名稱</th><th>尺寸/大小</th><th>款式</th><th>價格(NT$)</th><th>修改</th><th>刪除</th>";
                                    echo "<tr/>";
                                echo "</thead>";
                            ...
                            while($row=mysqli_fetch_assoc($result)){
                                echo "<tr>";
                                echo "<td>".$row["pNo"]."</td><td>".$row["pName"]."</td><td>".$row["pSize"]."</td><td>".$row["pStyle"]."</td><td>".$row["pPrice"]."</td>";
                                echo "<form action='commodity_revise.php' method='POST'>"; 
                                    echo "<td><input class='btn btn-primary btn-sm' type='submit' name='revise' value='修改'></td>";
                                    echo "<input type='hidden' name='pNo' value='".$row['pNo']."'>";
                                echo "</form>";
                                echo "<form action='commodity_delete.php' method='POST'>"; 
                                    echo "<td><input class='btn btn-primary btn-sm' type='submit' name='revise' value='刪除'></td>";
                                    echo "<input type='hidden' name='pNo' value='".$row['pNo']."'>";
                                echo "</form>";
                                echo "</tr>";
                            }
                    ...
                    ?>  
                    <h6 style="margin: 25% 0 0 0; color:#ffffff;">1</h1>
                </div>
            </div>
            </div>
        </div>
