        ...
        <div class="tab-content">
            ...
            <div style="margin: 5% 5% 0 5%">
                <div class="tab-content-center">
                    ...
                    <?php
                        ...
                        if($result=mysqli_query($link,$SQL)){
                            echo "<table class='table table-striped table-sm'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th>使用者編號</th><th>帳號</th><th>密碼</th><th>信箱</th><th>身分</th><th>修改</th><th>刪除</th>";
                                    echo "<tr/>";
                                echo "</thead>";
                            ...
                            while($row=mysqli_fetch_assoc($result)){
                                echo "<tr>";
                                echo "<td>".$row["uNo"]."</td><td>".$row["uName"]."</td><td>".$row["uPwd"]."</td><td>".$row["uEmail"]."</td><td>".$row["uRole"]."</td>";
                                echo "<form action='user_revise.php' method='POST'>"; 
                    ...
                    ?>  
                    <h6 style="margin: 30% 0 0 0; color:#ffffff;">1</h1>
                </div>
            </div>
            </div>
        </div>
