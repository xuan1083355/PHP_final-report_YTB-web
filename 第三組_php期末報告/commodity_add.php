    ...
    <div class="col-md-9">
        <div class="tab-content">
            ...
            <div class="tab-content-center">
                    <table>
                        <form action="commodity_addConfirm.php" method="post" enctype="multipart/form-data">
                        <tr>
                            <td>商品名稱:</td>
                            <td align="center">
                                <select name="name" required>
                                    <option value='黃大謙 UCCU大學tee'>黃大謙 UCCU大學tee</option>
                                    <option value='做自己很好 勵志A5筆記本'>做自己很好 勵志A5筆記本</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td>尺寸大小</td>
                            <td align="center"><input type="text" name="size" placeholder="尺寸大小" required></td>
                        </tr>
                        <tr>
                            <td>款式</td>
                            <td align="center"><input type="text" name="style" placeholder="款式" required></td>
                        </tr>
                        <tr>
                            <td>價格</td>
                            <td align="center"><input type="text" name="price" placeholder="價格" required></td>
                        </tr>
                        <tr>
