    ...
    <div class="col-md-9">
        <div class="tab-content">
            ...
            <div class="tab-content-center">
                <form action="commodity_update.php" method="post">
                    <table>
                        <tr>
                            <td colspan="2" align="center">商品編號: <?php echo $row["pNo"]; ?><input type="hidden" name="pNo" value="<?php echo $row["pNo"]; ?>"></th>
                            </td>
                        <tr>
                            <td>商品名稱:</td>
                        ...
                        <tr>
                            <td>尺寸大小</td>
                            <td><input type="text" name="size" value="<?php echo $row['pSize'];?>" required></td>
                        </tr>
                        <tr>
                            <td>款式</td>
                            <td><input type="text" name="style" value="<?php echo $row['pStyle'];?>" required></td>
                        </tr>
                        <tr>
                        <td>價格</td>
                            <td><input type="text" name="price" value="<?php echo $row['pPrice'];?>" required></td>
                        </tr>
                        <tr>
