            ...
            <div class="col-md-16">
                ...
                <table>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <!-- <a href="forgor.php" style="float: left; color:#FFA514;">忘記密碼</a> -->
                            <a href="singup.php" style="float: right; color:#FFA514;">註冊</a></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center"><input type="submit" value="登入" style="background-color:#FFA514; cursor:pointer;"></td>
                    </tr>
                    </form>
                </table>
                <?php
                ...
                ?>
                <h6 style="margin: 23% 0 0 0; color:#ffffff;">1</h1>
            </div>
