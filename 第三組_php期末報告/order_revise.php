        ...
        <div class="tab-content">
            ...
            <div class="tab-content-center">
                <form action="order_update.php" method="post">
                    <table>
                        <tr>
                            <td colspan="2" align="center">訂單編號: <?php echo $row["oNo"]; ?><input type="hidden" name="oNo" value="<?php echo $row["oNo"]; ?>"></th>
                            </td>
                        </tr>
                        <tr>
                            <td>訂購商品</td>
                            <td><input type="text" name="oOrder" value=" <?php echo str_replace("</br>"," ",$_POST['oOrder']);?> ">
                            </td>
                        </tr>
                        <tr>
                            <td>寄送地址</td>
                            <td><input type="text" name="oAddress" value=" <?php echo $_POST['oAddress']; ?> "></td>
                        </tr>
